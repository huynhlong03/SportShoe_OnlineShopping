...
namespace SportShoes.Migrations
{
    ...
    [Migration("20240514135208_AddImportCouponTable")]
    partial class AddImportCouponTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportShoes.Models.ImportCoupon", b =>
                {
                    b.Property<int>("ImportCouponID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ImportCouponID"));
            ...
            modelBuilder.Entity("SportShoes.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("SportShoes.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("SportShoes.Models.Voucher", b =>
                {
                    b.Property<int>("VoucherID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportShoes.Models.Order", b =>
                {
                    b.HasOne("SportShoes.Models.ApplicationUser", "AspNetUser")
                        .WithMany()
                        .HasForeignKey("AspNetUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportShoes.Models.DeliveryStatus", "DeliveryStatus")
                        .WithMany()
                        .HasForeignKey("DeliveryStatusID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportShoes.Models.Voucher", "Voucher")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("SportShoes.Models.OrderDetail", b =>
                {
                    b.HasOne("SportShoes.Models.ColorSize", "ColorSize")
                        .WithMany()
                        .HasForeignKey("ColorSizeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportShoes.Models.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ColorSize");
